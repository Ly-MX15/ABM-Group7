...
class SugarScape(Model):
    def __init__(self, height=50, width=50, initial_population=100,
                 tax_scheme="flat", tax_steps=10, tax_rate=0, distributer_scheme="flat", distributer_steps=20,
        ...
        self.averagewellfare = []
        self.averagewellfare_step = []]
    ...
    def step(self):
        ...
        self.averagewellfare.append(self.averagewellfare_step)
        # Get all trader
    ...
    def repopulation(self):
        ...
        sugar, spice = 15,15
        sugar_metabolism, spice_metabolism = np.random.randint(2, 6, 2)
