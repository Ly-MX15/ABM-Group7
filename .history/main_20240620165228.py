...
server = ModularServer(
    SugarScape,
    [canvas_element, average_wealth_chart, Std_trade_price_charttrader_count_chart, trade_count_chart, average_trade_price_chart, gini_pop,
    ...
    {"height": 50, "width": 50, 
     ...
     'tax_scheme':"progressive", 'distributer_scheme':"progressive"}
)
