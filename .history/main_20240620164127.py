...
canvas_element = CanvasGrid(agent_portrayal, height=50, width=50, initial_population=100,
                 tax_scheme="progressive", tax_steps=10, tax_rate=0.2, distributer_scheme="progressive", distributer_steps=20,
...
server = ModularServer(
    SugarScape,
    [canvas_element, average_wealth_chart, trader_count_chart, trade_count_chart, average_trade_price_chart, gini_pop,
