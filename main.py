...
# plot_and_save(data[['GiniCoefficient']], 'Gini Coefficient', 'Gini Coefficient over Time',
#               'gini_coefficient_over_time.png')
# plot_and_save(data[['AverageVision']], 'Average Vision', 'Average Vision over Time', 'average_vision_over_time.png')
# plot_and_save(data[['AverageSugarMetabolism', 'AverageSpiceMetabolism']], 'Average Metabolism',
#               'Average Metabolism over Time', 'average_metabolism_over_time.png')
# plot_and_save(data[['PriceStabilization']], 'Price Stabilization', 'Price Stabilization over Time',
#               'price_stabilization_over_time.png')
